...
--
-- Host: localhost
-- Generation Time: Feb 23, 2026 at 08:18 PM
...
CREATE TABLE `sensor_logs` (
  ...
  `ultrasonic_distance_cm` float DEFAULT NULL,
  `sound_db` float DEFAULT NULL,
  `pir_status` enum('STABLE','MOTION') DEFAULT 'STABLE',
  `lock_state` enum('HARD-LOCK','UNLOCKED') DEFAULT 'UNLOCKED',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
